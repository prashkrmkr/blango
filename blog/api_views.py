...
#     } # instead we are using PostSerializer 
...
#     return HttpResponseNotAllowed(["GET", "POST"])   # use api_view instead
...
#     return HttpResponseNotAllowed(["GET", "PUT", "DELETE"])   # use api_view instead